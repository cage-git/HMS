    	...
    	<div class="row">
            ...
            <div class="col-xl-12 col-md-12 col-12 pb-2">
              <div class="form-check form-check-inline">
                  <input class="form-check-input" name="expenses" type="checkbox" value="expenses">
                  <label class="form-check-label" for="expenses">Expenses</label>
              </div>
              <div class="form-check form-check-inline">
                  <input class="form-check-input" name="pos" type="checkbox" value="pos">
                  <label class="form-check-label" for="pos">POS</label>
              </div>
              <div class="form-check form-check-inline">
                  <input class="form-check-input" name="website" type="checkbox" value="website">
                  <label class="form-check-label" for="website">Web site</label>
              </div>
              <div class="form-check form-check-inline">
                  <input class="form-check-input" name="laundry" type="checkbox" value="laundry">

  ...
  <div class="col-md-12 col-12">
    @if(session('success'))
        ...
        <div class="card">
            ...
            <div class="card-body">
                @if($flag==1)
                      {{ Form::model($data_row,array('url'=>route('save-food-category'),'id'=>"food-category-form", 'class'=>"form-horizontal form-label-left")) }}
                      {{Form::hidden('id',null)}}
                  @else
                      {{ Form::open(array('url'=>route('save-food-category'),'id'=>"food-category-form", 'class'=>"form-horizontal form-label-left")) }}
                  @endif
                        <div class="row">
                                <div class="col-xl-4 col-md-6 col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="basic-default-name">{{lang_trans('txt_category_name')}}</label><span class="required text-danger">*</span>
                                ...
                                <div class="col-xl-4 col-md-6 col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="product_name">{{lang_trans('txt_category_name')}}</label>
          ...
          <div class="x_panel">
              ...
              <div class="x_content">
                  ...
                  @endif
                      ...
                      <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12">{{lang_trans('txt_category_name')}}</label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
...
@section('scripts')
    ...
    <!-- BEGIN: Page JS-->
        <script src="{{URL::asset('public/app-assets/js/scripts/forms/food-category-form-validation.js')}}"></script>
    <!-- END: Page JS-->
@endsection
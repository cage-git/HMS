                      ...
                      <div class="panel panel-default">
                        <div class="panel-heading">
                          <h4 class="panel-title">
                            ...
                            <a class="room_type_by_rooms" data-roomtypeid="{{$roomType->id}}" data-toggle="collapse" href="#collapse{{$k}}">{{$roomType->title}}</a>

                              {{Form::number('roomtype_'.$roomType->id,rtrim($change_value[1], ')'),[ "data-original"=>rtrim($change_value[1], ')'),"class"=>"room_price calculate_total_amount","required"=>"required"])}}
                          </h4>
                        </div>

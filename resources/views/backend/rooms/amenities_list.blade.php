                      ...
                      @foreach($datalist as $k=>$val)
                        <tr>
                          ...
                          <td>
                            ...
                            <button class="btn btn-danger btn-sm delete_btn" data-url="{{route('delete-amenities',[$val->id])}}" title="{{lang_trans('btn_delete')}}"  data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><i data-feather='trash'></i></button>
                          </td>
                        </tr>
                      @endforeach

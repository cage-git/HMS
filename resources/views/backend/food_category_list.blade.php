        ...
        <div class="col-12">
            <div class="card p-2">
                <div class="card-header px-0 border-bottom">
                    ...
                    <a href="{{route('add-food-category')}}"><button class="btn btn-primary" >{{lang_trans('sidemenu_foodcat_add')}}</button></a>
                </div>
                <table class="datatables-basic table">
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-sm btn-info" href="{{route('edit-food-category',[$val->id])}}" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i data-feather='edit'></i></a>
                            <button class="btn btn-danger btn-sm delete_btn" data-url="{{route('delete-food-category',[$val->id])}}" title="{{lang_trans('btn_delete')}}" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><i data-feather='trash-2'></i></button>
                          </td>
                        </tr>
                      @endforeach
                    </tbody>

                                    ...
                                    @foreach($datalist as $k=>$val)
                                      <tr>
                                        ...
                                        <td>
                                          ...
                                          <button id="confirm-text" class="btn btn-danger btn-sm delete_btn" data-url="{{route('delete-expense-category',[$val->id])}}" title="{{lang_trans('btn_delete')}}" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><i data-feather='trash-2'></i></button>
                                        </td>
                                      </tr>
                                    @endforeach

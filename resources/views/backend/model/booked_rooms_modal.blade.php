<div class="modal fade text-start" id="booked_room_{{$val->id}}" tabindex="-1" aria-labelledby="myModalLabel21" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel21">{{lang_trans('txt_heading_booked_rooms')}}</h4>

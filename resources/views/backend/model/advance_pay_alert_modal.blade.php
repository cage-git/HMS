<div id="advance_pay_alert_{{$val->id}}" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      {{ Form::hidden('id', $val->id) }}
        ...
        <div class="modal-body">
          ...
          <br/>
            <div class="form-group w-100">
              <label class="control-label col-sm-12 text-success">{{lang_trans('txt_due_amount')}}: {{($dueAmount) ? number_format((float)$dueAmount, 2, '.', '') : 0}}</label>
          </div>
          <br/>
          <div class="form-group w-100">
              <label class="control-label col-sm-12">{{lang_trans('txt_amount')}}<span class="required">*</span></label>
              <div class="col-sm-12">
                  {{ Form::text('advance_payment',null,array('class'=>"form-control w-100", 'min'=>0, 'required'=>true, 'placeholder'=>'Add More Amount')) }}
              </div>
          </div>
          <div class="form-group w-100">
